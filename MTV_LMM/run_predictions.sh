...
do 
	...
	mkdir Data_files/Prediction/Prediction_1_time_point_FF_$number
  	...
  	t="$line"	
		...
		/home/cozygene/cozygene/software/GCTA_1.26/gcta64 --grm-gz Data_files/Kinship_mat_files/Kinship_3_bins_$t --make-grm --out Data_files/GRM_files_pred/GRM_3_bins__1_$t
		/home/cozygene/cozygene/software/GCTA_1.26/gcta64 --grm-gz Data_files/Kinship_mat_files/Kinship_3_bins_shuff_$t --make-grm --out Data_files/GRM_files_pred/GRM_3_bins__2_$t
